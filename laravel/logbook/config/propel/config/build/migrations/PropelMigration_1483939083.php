 ...
 * up to version 1483939083.
 * Generated on 2017-01-09 05:18:03 by Pharz
 */
class PropelMigration_1483939083
{
...
ALTER TABLE `oauth_clients` CHANGE `created_at` `created_at` DATETIME;

ALTER TABLE `oauth_clients` CHANGE `created_by` `created_by` INTEGER(11);

ALTER TABLE `oauth_clients` CHANGE `updated_at` `updated_at` DATETIME;
