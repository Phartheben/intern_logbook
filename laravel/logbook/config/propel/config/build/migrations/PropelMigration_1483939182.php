 ...
 * up to version 1483939182.
 * Generated on 2017-01-09 05:19:42 by Pharz
 */
class PropelMigration_1483939182
{
...
ALTER TABLE `activity` CHANGE `created_at` `created_at` DATETIME;

ALTER TABLE `activity` CHANGE `created_by` `created_by` INTEGER(11);

ALTER TABLE `activity` CHANGE `updated_at` `updated_at` DATETIME;

ALTER TABLE `activity` CHANGE `updated_by` `updated_by` INTEGER(11);

ALTER TABLE `comment` CHANGE `created_at` `created_at` DATETIME;

ALTER TABLE `comment` CHANGE `created_by` `created_by` INTEGER(11);

ALTER TABLE `comment` CHANGE `updated_at` `updated_at` DATETIME;
...
ALTER TABLE `oauth_access_codes` CHANGE `created_at` `created_at` DATETIME;

ALTER TABLE `oauth_access_codes` CHANGE `created_by` `created_by` INTEGER(11);

ALTER TABLE `oauth_access_codes` CHANGE `updated_at` `updated_at` DATETIME;
...
ALTER TABLE `oauth_personal_access_clients` CHANGE `created_at` `created_at` DATETIME;

ALTER TABLE `oauth_personal_access_clients` CHANGE `created_by` `created_by` INTEGER(11);

ALTER TABLE `oauth_personal_access_clients` CHANGE `updated_at` `updated_at` DATETIME;

ALTER TABLE `oauth_personal_access_clients` CHANGE `updated_by` `updated_by` INTEGER(11);

ALTER TABLE `oauth_refresh_tokens` CHANGE `created_at` `created_at` DATETIME;

ALTER TABLE `oauth_refresh_tokens` CHANGE `created_by` `created_by` INTEGER(11);

ALTER TABLE `oauth_refresh_tokens` CHANGE `updated_at` `updated_at` DATETIME;

ALTER TABLE `oauth_refresh_tokens` CHANGE `updated_by` `updated_by` INTEGER(11);

ALTER TABLE `role` CHANGE `created_at` `created_at` DATETIME;

ALTER TABLE `role` CHANGE `created_by` `created_by` INTEGER(11);

ALTER TABLE `role` CHANGE `updated_at` `updated_at` DATETIME;

ALTER TABLE `role` CHANGE `updated_by` `updated_by` INTEGER(11);

ALTER TABLE `user` CHANGE `created_at` `created_at` DATETIME;

ALTER TABLE `user` CHANGE `created_by` `created_by` INTEGER(11);

ALTER TABLE `user` CHANGE `updated_at` `updated_at` DATETIME;
