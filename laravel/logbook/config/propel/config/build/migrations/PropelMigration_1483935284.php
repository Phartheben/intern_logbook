 ...
 * up to version 1483935284.
 * Generated on 2017-01-09 04:14:44 by Pharz
 */
class PropelMigration_1483935284
{
...
CREATE INDEX `oauth_access_tokens_FI_1` ON `oauth_access_tokens` (`user_id`);

ALTER TABLE `oauth_clients` CHANGE `id` `id` INTEGER(10) NOT NULL AUTO_INCREMENT;
...
DROP INDEX `oauth_access_tokens_FI_1` ON `oauth_access_tokens`;
...
ALTER TABLE `oauth_clients` CHANGE `id` `id` VARCHAR(100) NOT NULL;
