...
class UserCompanyController extends AppController
{
    /**
    ...
    public function index()
    {
        ...
        try {
            ...
            $model = new \App\Models\UserCompany;
                        // ----@ add criteria here;
            $data  = $model->paginate();
    ...
    public function store()
    {
        ...
        $data = new \App\Models\UserCompany;
    ...
    {
        $data->duration = array_get($input, 'duration');
        $data->start_date = array_get($input, 'start_date');
        $data->end_date = array_get($input, 'end_date');
    }
}
